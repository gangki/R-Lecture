...
data1 <- sapply(txt1, extractNoun, USE.NAMES = F)
data2 <- sapply(txt2, extractNoun, USE.NAMES = F)
data3 <- sapply(txt3, extractNoun, USE.NAMES = F)
data4 <- sapply(txt4, extractNoun, USE.NAMES = F)
data5 <- sapply(txt5, extractNoun, USE.NAMES = F)
data6 <- sapply(txt6, extractNoun, USE.NAMES = F)
data7 <- sapply(txt7, extractNoun, USE.NAMES = F)
data8 <- sapply(txt8, extractNoun, USE.NAMES = F)
data9 <- sapply(txt9, extractNoun, USE.NAMES = F)
data10 <- sapply(txt10, extractNoun, USE.NAMES = F)
data11 <- sapply(txt11, extractNoun, USE.NAMES = F)
data12 <- sapply(txt12, extractNoun, USE.NAMES = F)

head(unlist(data1), 30)
head(unlist(data2), 30)
head(unlist(data3), 30)
head(unlist(data4), 30)
head(unlist(data5), 30)
head(unlist(data6), 30)
head(unlist(data7), 30)
head(unlist(data8), 30)
head(unlist(data9), 30)
head(unlist(data10), 30)
head(unlist(data11), 30)
...
cdata8 <- unlist(data8)
cdata9 <- unlist(data9)
cdata10 <- unlist(data10)
cdata11 <- unlist(data11)
cdata12 <- unlist(data12)
...
wordcloud(names(wc_seoul1), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
...
wordcloud(names(wc_seoul2), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"2월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul3), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"3월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul4), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"4월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul1), freq = wc_seoul5, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"5월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul1), freq = wc_seoul6, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"6월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul7), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"7월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul8), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"8월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul9), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"9월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul10), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"10월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul11), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
legend(0.3,1 ,"11월 서울시 응답소 키워드",cex=0.8,fill=NA,border=NA,bg="white" ,
       text.col="red",text.font=2,box.col="red")

wordcloud(names(wc_seoul12), freq = wc_seoul1, scale = c(5,0.25), rot.per = 0.25,
          min.freq = 2, max.words = 200, random.order = F, random.color = T, colors = palete)
